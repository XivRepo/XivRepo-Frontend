<template>
  <div class="main">
    <div class="container">
      ...
      <p>
        At The XIV Repository, accessible from {{ siteUrl }}, one of our main
        priorities is the privacy of our visitors. This Privacy Policy document
        contains types of information that is collected and recorded by The XIV
        Repository and how we use it.
      </p>
      ...
      <p>
        The XIV Repository legal basis for collecting and using the personal
      ...
      <ul>
        <li>The XIV Repository needs to perform a contract with you</li>
        <li>You have given The XIV Repository permission to do so</li>
        <li>
          Processing your personal information is in The XIV Repository
          legitimate interests
        </li>
        <li>The XIV Repository needs to comply with the law</li>
      </ul>

      <p>
        The XIV Repository will retain your personal information only for as
      ...
      <p>
        The XIV Repository follows a standard procedure of using log files.
      ...
      <p>
        Like any other website, The XIV Repository uses 'cookies'. These cookies
      ...
      <P
        ...
        advertising partners of The XIV Repository.</P
      >

      <p>
        Third-party ad servers or ad networks uses technologies like cookies,
        JavaScript, or Web Beacons that are used in their respective
        advertisements and links that appear on The XIV Repository, which are
      ...
      <p>
        Note that The XIV Repository has no access to or control over these
      ...
      <p>
        The XIV Repository's Privacy Policy does not apply to other advertisers
      ...
      <p>
        The XIV Repository does not knowingly collect any Personal Identifiable
      ...
      <p>
        ...
        shared and/or collect in The XIV Repository. This policy is not
...
export default {
  ...
  auth: false,
  head: {
    title: 'Privacy - The XIV Repository',
    meta: [
      {
        hid: 'description',
        name: 'description',
        content:
          'The privacy policy of The XIV Repository, an open source modding platform. The XIV Repository currently supports Minecraft, including the forge and fabric mod loaders.',
      },
      {
