<template>
  <div class="main">
    <div class="container">
      ...
      <p>
        XIVMods follows a standard procedure of using log files. These files log
      ...
      <p>
        Like any other website, XIVMods uses 'cookies'. These cookies are used
      ...
      <P
        ...
        advertising partners of XIVMods.</P
      >

      <p>
        Third-party ad servers or ad networks uses technologies like cookies,
        JavaScript, or Web Beacons that are used in their respective
        advertisements and links that appear on XIVMods, which are sent directly
      ...
      <p>
        Note that XIVMods has no access to or control over these cookies that
      ...
      <p>
        XIVMods's Privacy Policy does not apply to other advertisers or
      ...
      <p>
        XIVMods does not knowingly collect any Personal Identifiable Information
      ...
      <p>
        ...
        shared and/or collect in XIVMods. This policy is not applicable to any
    ...
    meta: [
      {
        ...
        name: 'description',
        content:
          'The privacy policy of XIVMods, an open source modding platform. XIVMods currently supports Minecraft, including the forge and fabric mod loaders.',
      },
      {
